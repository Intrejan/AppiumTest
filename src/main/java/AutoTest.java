...
public class AutoTest {
    ...
    private void Prepare(String pageSource, AppiumDriver<WebElement> driver) {
        ...
        try{
            driver.findElementsByName("始终允许").get(0).click();

        } catch (Exception e) {
            System.out.println("未定位到‘始终允许’。");
        }
    ...
    public static void main(String[] args) {
        ...
        final String UDID = args[1];
        final String appiumUrl =args[2];
        int runtime = Integer.parseInt(args[3]);
        final ExecutorService exec = Executors.newFixedThreadPool(1);
        Callable<String> call = new Callable<String>(){
            public String call() throws Exception {
                AutoTest main = new AutoTest();
                //先判断是否有这个app
        ...
        try {
            ...
            String obj = future.get(runtime*1000, TimeUnit.MILLISECONDS);
